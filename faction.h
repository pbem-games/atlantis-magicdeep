...
public:
	...
	// dsnlab & VVR
	void WriteReport( Areport *f, Game *pGame, int ** );
	...
	AString DetailedTaxReport();
	AString DetailedLeadersReport(Game *);
	...
	AList fishing_regions; // dsnlab & VVR
	AList roadbuild_regions; // dsnlab & VVR
