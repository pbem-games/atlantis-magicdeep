...
class DisassembleOrder : public Order {
	public:
		DisassembleOrder();
		~DisassembleOrder();
		...
		int item;
                int skill;
                int level;
                int mat[4][2];  //[x][0] - item, [x][1] - amt
};

class TownOrder : public Order {
	public:
		TownOrder();
		~TownOrder();
...
class CastTransformFromOrder : public CastOrder {
	public:
		CastTransformFromOrder();
		~CastTransformFromOrder();
...
class ChannelOrder : public CastOrder {
        public:
                ChannelOrder();
                ~ChannelOrder();

                int direction; // 0 - to, 1 - from

                int targtype;  // -1 - faction (legacy)
                               // 0 - unit
                               // 2 - region
                               // 3 - item
                               // 4 - object
